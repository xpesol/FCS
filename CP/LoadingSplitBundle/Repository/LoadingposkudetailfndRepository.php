...
namespace FCS\CP\LoadingSplitBundle\Repository;
...
class LoadingposkudetailfndRepository extends \Doctrine\ORM\EntityRepository
{
	...
	public function findQuantitesByCpEntrepotIdLoadingPoSku($entrepot, $idLoadingPoSku)
		{	   
		  ...
		  'SELECT a FROM FCSCPLoadingSplitBundle:Loadingposkudetailfnd a WHERE a.idloadingposku = :idloadingposku AND a.entrepot = :entrepot');
